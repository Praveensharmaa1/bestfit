...
function App() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white text-center p-6">
      <div>
        <h1 className="text-4xl font-bold mb-4 text-blue-700">BestFit Resume</h1>
        <p className="text-lg text-gray-600 mb-6">
          Build professional resumes with AI-powered suggestions and export them in one click.
        </p>
